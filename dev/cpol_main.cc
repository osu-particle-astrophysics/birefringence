...
//			    cout << "i, model_data.vattens[i][idepth], model_data.vrxdepth_atten[i][idepth], model_data.vspectra are " << i << "\t" << model_data.vattens[i][idepth][ifreq] << "\t" << model_data.vrxdepth_atten[i][idepth] << "\t" << model_data.vspectra[i][idepth][ifreq] << "\n";
    ...
    for (int i=geom.minstation;i<=geom.maxstation;i++) {
        ...
        model_data.g_parameter0[i]->SetLineWidth(3);
        model_data.g_parameter0[i]->SetLineColor(kGreen);

        model_data.g_atten[i]->SetLineWidth(3);
        model_data.g_atten[i]->SetLineColor(kOrange);

        model_data.g_atten_beam[i]->SetLineWidth(3);
        model_data.g_atten_beam[i]->SetLineStyle(kDashed);
        model_data.g_atten_beam[i]->SetLineColor(kOrange);

        model_data.g_atten_beam_crosspol[i]->SetLineWidth(3);
        model_data.g_atten_beam_crosspol[i]->SetLineStyle(kDashed);
        model_data.g_atten_beam_crosspol[i]->SetLineColor(kOrange);

        model_data.gfunc_noadjust[i]->SetLineWidth(3);
        model_data.gfunc_noadjust[i]->SetLineColor(kBlack);

        model_data.g_atten_beam_crosspol_nointerferencefunc[i]->SetLineWidth(3);
        model_data.g_atten_beam_crosspol_nointerferencefunc[i]->SetLineStyle(kDashed);
        model_data.g_atten_beam_crosspol_nointerferencefunc[i]->SetLineColor(kBlack);

        model_data.g_atten_beam_crosspol_func[i]->SetLineWidth(3);
        model_data.g_atten_beam_crosspol_func[i]->SetLineColor(kBlack);
        ...
        for (int j=0;j<NDISTANCES_BIGPIC-(jmin[i]+1);j++) {
            ...
            double pospulser[2];
            pospulser[0]=0.;
            pospulser[1]=model_data.vpseudodepths_bigpic[i][j];
            ...
            if (getresults[6]!=-1000 || getresults[8]!=-1000) {
                ...
                for (int istep=UZAIRSTEP;istep<res.size();istep+=UZAIRSTEP) {
                    ...
                    if (istep>0) {
                        ...
                        double deltan_alongpath=getDeltaN(cfg.BIAXIAL,nvec_thisstep,rhat_thisstep,geom.angle_iceflow,n_e1,n_e2,p_e1,p_e2,cfg.phi,cfg.theta,cfg.gamma);
                ...
                model_data.vtimediff_bigpic[i].push_back(sumphase);
                ...
                if (geom.DORAYTRACING) {
                    ...
                    model_data.rhat_launch[i].SetX(geom.station_coords[i][0]-geom.pulser_coords[0]);
                    model_data.rhat_launch[i].SetY(geom.station_coords[i][1]-geom.pulser_coords[1]);
                    model_data.rhat_launch[i].SetZ(geom.station_depths[i]-model_data.vpseudodepths_bigpic[i][j]);
        ...
        g_atten_beam_distances[i]=new TGraph(model_data.vdistances_bigpic[i].size(),&model_data.vdistances_bigpic[i][0],&model_data.vmag_atten_beam_bigpic[i][0]);
        g_atten_beam_crosspol_distances[i]=new TGraph(model_data.vdistances_bigpic[i].size(),&model_data.vdistances_bigpic[i][0],&model_data.vmag_atten_beam_crosspol_bigpic[i][0]);
        g_atten_beam_crosspol_nointerferencefunc_distances[i]=new TGraph(model_data.vdistances_bigpic[i].size(),&model_data.vdistances_bigpic[i][0],&model_data.vmag_atten_beam_crosspol_nointerferencefunc_bigpic[i][0]);
        g_atten_beam_crosspol_func_distances[i]=new TGraph(model_data.vdistances_bigpic[i].size(),&model_data.vdistances_bigpic[i][0],&model_data.vmag_atten_beam_crosspol_func_bigpic[i][0]);

        g_sumphase_distances[i]=new TGraph(model_data.vdistances_bigpic[i].size(),&model_data.vdistances_bigpic[i][0],&model_data.vtimediff_bigpic[i][0]);
    }
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        model_data.g_atten_beam_crosspol_func[istations]->SetLineColor(icolors_dave[istations]);
        model_data.g_atten_beam_crosspol_func[istations]->Draw("same");
    }
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_sumphase[istations]->SetMarkerColor(icolors[istations]);
        model_data.g_sumphase[istations]->SetLineColor(icolors[istations]);
        model_data.g_sumphase[istations]->SetLineStyle(kSolid);
        model_data.g_sumphase[istations]->SetLineWidth(3);


        model_data.g_sumphase[istations]->Draw("lsame");

        legend26a->AddEntry(model_data.g_sumphase[istations],geom.snames[istations].c_str(),"l");
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        c9a->cd(istations+1);
        h9a->Draw();
        model_data.g_notflipped[istations]->SetMarkerColor(icolors[istations]);
        model_data.g_notflipped[istations]->SetLineColor(icolors[istations]);
        model_data.g_notflipped[istations]->SetLineStyle(kSolid);
        model_data.g_notflipped[istations]->SetLineWidth(2);

        model_data.g_notflipped[istations]->Draw("lsame");
    }
    ...
    for (int istations=geom.minstation;istations<=geom.minstation;istations++) {
        ...
        model_data.g_sumlength[istations]->SetMarkerColor(icolors[istations]);
        model_data.g_sumlength[istations]->SetLineColor(icolors[istations]);
        model_data.g_sumlength[istations]->SetLineStyle(kSolid);
        model_data.g_sumlength[istations]->SetLineWidth(2);

        model_data.g_sumlength[istations]->Draw("lsame");
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_spectra[istations][(int)model_data.g_idepth[istations]->Eval(geom.depth_special)]->SetMarkerColor(icolors[istations]);
        model_data.g_spectra[istations][(int)model_data.g_idepth[istations]->Eval(geom.depth_special)]->SetLineColor(icolors[istations]);
        model_data.g_spectra[istations][(int)model_data.g_idepth[istations]->Eval(geom.depth_special)]->SetLineStyle(kSolid);
        model_data.g_spectra[istations][(int)model_data.g_idepth[istations]->Eval(geom.depth_special)]->SetLineWidth(2);

        model_data.g_spectra[istations][(int)model_data.g_idepth[istations]->Eval(geom.depth_special)]->Draw("al");
    }
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_deltan_pulserdepth[istations]->SetMarkerColor(icolors[istations]);
        model_data.g_deltan_pulserdepth[istations]->SetLineColor(icolors[istations]);
        model_data.g_deltan_pulserdepth[istations]->SetLineStyle(kSolid);
        model_data.g_deltan_pulserdepth[istations]->SetLineWidth(2);

        model_data.g_deltan_pulserdepth[istations]->Draw("lsame");
    }
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_attenlengths[istations]->SetMarkerColor(icolors[istations]);
        model_data.g_attenlengths[istations]->SetLineColor(icolors[istations]);
        model_data.g_attenlengths[istations]->SetLineStyle(kSolid);
        model_data.g_attenlengths[istations]->SetLineWidth(2);

        model_data.g_attenlengths[istations]->Draw("al");
    }
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_notflipped_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_notflipped_alongpath[istations]->SetLineStyle(kSolid);
        model_data.g_notflipped_alongpath[istations]->SetLineWidth(2);
        model_data.g_notflipped_alongpath[istations]->Draw("lsame");
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_theta1_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_theta1_alongpath[istations]->SetLineStyle(kSolid);
        model_data.g_theta1_alongpath[istations]->SetLineWidth(2);
        model_data.g_theta1_alongpath[istations]->Draw("lsame");
        model_data.g_theta2_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_theta2_alongpath[istations]->SetLineStyle(kDashed);
        model_data.g_theta2_alongpath[istations]->SetLineWidth(2);
        model_data.g_theta2_alongpath[istations]->Draw("lsame");
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_thetape1_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_thetape1_alongpath[istations]->SetLineStyle(kSolid);
        model_data.g_thetape1_alongpath[istations]->SetLineWidth(2);
        model_data.g_thetape1_alongpath[istations]->Draw("lsame");
        model_data.g_thetape2_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_thetape2_alongpath[istations]->SetLineStyle(kDashed);
        model_data.g_thetape2_alongpath[istations]->SetLineWidth(2);
        model_data.g_thetape2_alongpath[istations]->Draw("lsame");
    ...
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        ...
        model_data.g_thetape1_phipe1_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_thetape1_phipe1_alongpath[istations]->SetLineStyle(kSolid);
        model_data.g_thetape1_phipe1_alongpath[istations]->SetLineWidth(2);
        model_data.g_thetape1_phipe1_alongpath[istations]->Draw("lsame");
        model_data.g_thetape2_phipe2_alongpath[istations]->SetLineColor(icolors[istations]);
        model_data.g_thetape2_phipe2_alongpath[istations]->SetLineStyle(kDashed);
        model_data.g_thetape2_phipe2_alongpath[istations]->SetLineWidth(2);
        model_data.g_thetape2_phipe2_alongpath[istations]->Draw("lsame");
    ...
    h28a->Draw();
    for (int istations=geom.minstation;istations<=geom.maxstation;istations++) {
        model_data.g_depth_istep[istations]->Draw("lsame");
    }
    ...
    for (int istations=0;istations<geom.NSTATIONS;istations++) {
        ...
        for (int ispecial=0;ispecial<geom.NSPECIAL;ispecial++) {
            ...
            model_data.g_spectra[istations][(int)model_data.g_idepth[istations]->Eval(geom.whichspecial[ispecial])]->Write(name);
        }
        ...
        model_data.g_atten_power[istations]->Write(name);

        sprintf(name,"g_atten_beam_power_%d",istations);
        model_data.g_atten_beam_power[istations]->Write(name);
