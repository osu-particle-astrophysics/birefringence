...
void Geometry::compute_station_geometry(int BIAXIAL, const std::vector<double>& nvec, double phi, double theta, double gamma){
  ...
  n_e1,n_e2,p_e1,p_e2,phi,theta,gamma);
  }
  // ------------------------------------------------------------------------
  ...
  double n_e1;
  double n_e2;
  deltan_exp[5]=getDeltaN(BIAXIAL,nvec,pulsertostationhat_specialdepth[5],angle_iceflow,n_e1,n_e2,p_e1,p_e2,phi,theta,gamma);
