...
double getDeltaN(int BIAXIAL,vector<double> nvec,TVector3 rhat,double angle_iceflow, double &n_e1, double &n_e2,TVector3 &p_e1,TVector3 &p_e2, double phi, double theta, double gamma) {
   
  // Define the zenith and azimuth angles (in radians)
//    double gamma = -fmod(rotationParams.gamma  ,2*PI);
//    double theta = -fmod(rotationParams.theta ,2*PI);
//    double phi = -fmod(rotationParams.phi ,2*PI);
  //double gamma = 0.0 * PI/180.0;
  //double theta = -10.0 * PI/180.0;
  //double theta = 0.0 * PI/180.0;
  //double phi = 20.0 * PI/180.0;
  //double phi = 0.0 * PI/180.0;
  ...
  // Rotates with respect to the original coordinate axes
  TRotation rotation;
  ...
  // Performs the rotation on the indicatrix
